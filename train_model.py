...
#         if count > -1:
            ...
            # full file info
            train_data = tf2_processing.process(file_name, augmentation = True)
            ...
            model.fit(train_data, target_data, epochs=1, validation_split=0.1, verbose =1 , callbacks=[tensorboard_callback])
